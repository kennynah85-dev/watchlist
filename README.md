...
/* ── Table ── */
#wt{width:100%;border-collapse:collapse;table-layout:fixed}
th{background:#f5f5f3;color:#444;font-size:10px;font-weight:600;text-transform:uppercase;letter-spacing:.05em;padding:6px 7px;text-align:left;border-bottom:2px solid #ddd;white-space:nowrap;cursor:pointer;user-select:none;position:sticky;top:0;z-index:10}
...
td{padding:6px 7px;border-bottom:1px solid #f0f0ee;vertical-align:middle;line-height:1.4;overflow:hidden}
tr:hover td{background:#fafaf9}
tr.hide{display:none}

/* ── Col widths ── */
.c-sec  {width:8%;font-size:10px;color:#777;vertical-align:top}
.c-tick {width:6%;white-space:nowrap}
.c-name {width:9%}
.c-price{width:8%;text-align:right}
.c-mc   {width:8%;text-align:right}
.c-si   {width:6%;text-align:right;font-weight:600}
.c-chg  {width:6%;text-align:right;font-weight:600}
.c-hl   {width:9%;text-align:right}
.c-spark{width:7%;text-align:center;padding:4px 6px}
.c-soc  {width:16%}
.c-thesis{width:17%}
...
<table id="wt">
<colgroup>
  <col class="c-sec"><col class="c-tick"><col class="c-name">
  <col class="c-price"><col class="c-mc"><col class="c-si">
  <col class="c-chg"><col class="c-hl"><col class="c-spark">
  <col class="c-soc"><col class="c-thesis">
</colgroup>
<thead><tr>
